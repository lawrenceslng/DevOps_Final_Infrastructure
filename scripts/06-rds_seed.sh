...
AMI_ID="ami-0e449927258d45bc4"  # <-- Update this (use Amazon Linux 2 AMI or similar)
INSTANCE_TYPE="t2.micro"
KEY_PAIR_NAME="vockey"       # <-- Key pair you have in AWS
SECURITY_GROUP_ID="sg-0ff4e085c6f866094"  # <-- Security group allowing SSH
SUBNET_ID="subnet-0f3dd7d76bdc976d6"      # <-- Private or public subnet
